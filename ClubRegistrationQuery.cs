...
namespace FrmClubRegistration_Sanchez
{
    internal class ClubRegistrationQuery
    {
        ...
        {
            connectionString = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\MINER01\\source\\repos\\FrmClubRegistration-Sanchez\\ClubDB.mdf;Integrated Security=True";
        ...
        public bool RegisterStudent(int ID, long StudentID, string FirstName, string MiddleName, string LastName,
